...
CREATE TABLE `wxp_group` (
  ...
  `group_auth` mediumint(8) unsigned NOT NULL COMMENT '组权限，关联authrule表的id字段',
...
CREATE TABLE `wxp_printer` (
  ...
  `printer_weixin` smallint(6) unsigned NOT NULL COMMENT '公众号，关联weixin表weixin_id字段',
...
CREATE TABLE `wxp_weixin` (
  ...
  `weixin_number` varchar(50) NOT NULL COMMENT '公众号',
