...
$object_str=<<<EOF
                       ...
                       <video id="example_video_1_html5_api" class="vjs-tech video-js vjs-default-skin" preload="auto" autoplay="true" loop="true" width="100%" height="100%" controls="false"  poster="" data-setup="{}">
